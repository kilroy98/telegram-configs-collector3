...
def find_matches(text_content):
    ...
    "trojan://nd91608427@",
    "trojan://t9bpzivmnv@",
    "trojan://nishikuitan111@",
    "trojan://nishikuitan222@",
    "trojan://mitivpn@",
    "trojan://aimer@",
    "trojan://|??i_jkoeo!rcur2@",
    "trojan://0000@",
    "trojan://1111@",
    "trojan://1234567890@",
    "trojan://521314@",
    "trojan://8r%3C%5B9%27l6hao%238zqi@",
    "trojan://5a2c16f9@",
    "trojan://auto@",
    "trojan://sinavm@",
    "trojan://vpn@",
    ...
    "trojan://vpncustomize@"
    "trojan://watashi_vpn@",
    "trojan://rtp$2utwq4wvakod@",
    "trojan://e3408404-234b-4559-85a2-bad2c8ae351a@",
    "trojan://2bfe58f7-da1d-45df-ab43-7c665b20ee29@",
    "trojan://7f1744fb-e014-43e9-ab39-1dca96f5e604@",
    "trojan://6c0ed3fb-f0b0-5b53-a762-f8f8d832bdba@",
    "trojan://c65dbe85-354d-4892-909d-2b288830ee37@"
    )

    def fast_clean(lst):
        return [x for x in lst if not any(b.lower() in x.lower() for b in bad_words)]

    matches_shadowsocks = fast_clean(matches_shadowsocks)
    matches_trojan = fast_clean(matches_trojan)
    matches_vmess = fast_clean(matches_vmess)
    matches_vless = fast_clean(matches_vless)
    matches_reality = fast_clean(matches_reality)
    matches_tuic = fast_clean(matches_tuic)
    matches_hysteria = fast_clean(matches_hysteria)
    matches_hysteria_ver2 = fast_clean(matches_hysteria_ver2)
    matches_juicity = fast_clean(matches_juicity)
...
# url = 'https://raw.githubusercontent.com/kilroy98/telegram-proxies-collector3/main/telegram channels.json'
...
#Trying changes from ChatGPT
def load_subscription(url_link):
    try:
        links_content = html_content(url_link)
        return (url_link, links_content)
    except Exception:
        return None
...
with ThreadPoolExecutor(max_workers=20) as executor:
    results = executor.map(load_subscription, subscription_links)
...
for result in results:
    ...
    url_link, links_content = result

    array_links_content.append((url_link, links_content))

    if 'kilroy98' not in url_link:
        raw_array_links_content.append((url_link, links_content))
    elif 'kilroy98' in url_link and 'channels' in url_link:
...
dev_sign = "\U0001F468\U0001F3FB\u200D\U0001F4BB DEVELOPED-BY kilroy98 \U0001F4CC"
